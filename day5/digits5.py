...
#
# This is where all of the Random Forests stuff goes
#
import numpy as np
c = 0
scores_avgs = []
...
for m in m_range:
    for n in n_range:
        ...
        scores = cross_val_score(rforest, X_data_full, y_data_full, cv=15)
...
rforest = rforest.fit(X_data_full[9:,:], y_data_full[9:])

X_test = X_all[0:9,:]
predicted_labels = rforest.predict(X_test)
answer_labels = y_all[0:9]
