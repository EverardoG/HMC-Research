...
def test_most_similar(pos_words,neg_words,model):
    """ example of most_similar """
    # print("Testing most_similar on the king - man + woman example...")
    LoM = model.most_similar(positive=pos_words, negative=neg_words, topn=10)
...
def main():
    ...
    # visualize_wordvecs(["breakfast", "milk", "cereal", "eggs"], m)
    generate_analogy('mouse','cheese','dog',m)
    # print(doesnt_match_example(m))
    # textblob_examples()
